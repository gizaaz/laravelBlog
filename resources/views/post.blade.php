            ...
            <div class="col-full">
                ...
                <ol class="commentlist">
                    ...
                    <li class="depth-1 comment">
                        ...
                        <div class="comment__avatar">
                            <img width="50" height="50" class="avatar" src="{{asset('images/avatars/user-02.jpg')}}" alt="">
                        </div>
                ...
                <div class="respond">
                    ...
                    <form name="contactForm" id="contactForm" method="POST" action="{{route('addComment', ['id'=> $post->id])}}">
                        <fieldset>
